...
export const personas: Record<PersonaKey, PersonaTheme> = {
  lara: {
    ...
    title: ["Invest in the ideas you trust."],
    titleAccentWords: ["trust"],
  ...
  johann: {
    ...
    title: ["Discover and invest in early-stage startups"],
    titleAccentWords: ["invest"],
    subtitle: GLOBAL_SUBTITLE,
    cta: "Invest",
    ctaSecondary: "Show more",
    personaNote:
